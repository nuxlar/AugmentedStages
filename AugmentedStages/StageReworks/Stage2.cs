...
namespace AugmentedStages
{
  public class Stage2
  {
    public DirectorCardCategorySelection.Category[] ReworkAqueduct()
    {
      ...
      basicMonsters.cards = new DirectorCard[] { new DirectorCard() { spawnCard = AugmentedStages.lemurian, selectionWeight = 3 }, new DirectorCard() { spawnCard = AugmentedStages.jellyfish, selectionWeight = 3 }, new DirectorCard() { spawnCard = AugmentedStages.blindPest, selectionWeight = 3 } };
    ...
    public DirectorCardCategorySelection.Category[] ReworkWetland()
    {
      DirectorCardCategorySelection.Category basicMonsters = new DirectorCardCategorySelection.Category();
      basicMonsters.name = "Basic Monsters";
      basicMonsters.cards = new DirectorCard[] { new DirectorCard() { spawnCard = AugmentedStages.lemurian, selectionWeight = 4 }, new DirectorCard() { spawnCard = AugmentedStages.beetle, selectionWeight = 4 }, new DirectorCard() { spawnCard = AugmentedStages.blindPest, selectionWeight = 4 }, new DirectorCard() { spawnCard = AugmentedStages.jellyfish, selectionWeight = 4 } };
