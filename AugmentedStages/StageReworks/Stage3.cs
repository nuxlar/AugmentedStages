...
namespace AugmentedStages
{
  public class Stage3
  {
    public DirectorCardCategorySelection.Category[] ReworkRallypoint()
    {
      ...
      basicMonsters.cards = new DirectorCard[] { new DirectorCard() { spawnCard = AugmentedStages.imp, selectionWeight = 3 }, new DirectorCard() { spawnCard = AugmentedStages.blindVermin, selectionWeight = 3 }, new DirectorCard() { spawnCard = AugmentedStages.solusProbes, selectionWeight = 3 } };
      ...
      champions.cards = new DirectorCard[] { new DirectorCard() { spawnCard = AugmentedStages.impBoss, selectionWeight = 2 }, new DirectorCard() { spawnCard = AugmentedStages.magmaWorm, selectionWeight = 2 }, new DirectorCard() { spawnCard = AugmentedStages.solusControlUnit, selectionWeight = 2 }, new DirectorCard() { spawnCard = AugmentedStages.electricWorm, selectionWeight = 2 } };
    ...
    public DirectorCardCategorySelection.Category[] ReworkAcres()
    {
      DirectorCardCategorySelection.Category basicMonsters = new DirectorCardCategorySelection.Category();
      basicMonsters.name = "Basic Monsters";
      basicMonsters.cards = new DirectorCard[] { new DirectorCard() { spawnCard = AugmentedStages.lemurian, selectionWeight = 3 }, new DirectorCard() { spawnCard = AugmentedStages.blindPest, selectionWeight = 3 }, new DirectorCard() { spawnCard = AugmentedStages.vulture, selectionWeight = 3 }, new DirectorCard() { spawnCard = AugmentedStages.imp, selectionWeight = 3 } };
      basicMonsters.selectionWeight = 3;
      DirectorCardCategorySelection.Category minibosses = new DirectorCardCategorySelection.Category();
      minibosses.name = "Minibosses";
      ...
      DirectorCardCategorySelection.Category champions = new DirectorCardCategorySelection.Category();
      champions.name = "Champions";
      champions.cards = new DirectorCard[] { new DirectorCard() { spawnCard = AugmentedStages.impBoss, selectionWeight = 2 }, new DirectorCard() { spawnCard = AugmentedStages.clayDunestrider, selectionWeight = 2 }, new DirectorCard() { spawnCard = AugmentedStages.grovetender, selectionWeight = 2 } };
      champions.selectionWeight = 2;
      DirectorCardCategorySelection.Category special = new DirectorCardCategorySelection.Category();
      special.name = "Special";
      special.cards = new DirectorCard[] { new DirectorCard() { spawnCard = AugmentedStages.scav, selectionWeight = 1 } };
    ...
    public DirectorCardCategorySelection.Category[] ReworkPools()
    {
      ...
      DirectorCardCategorySelection.Category champions = new DirectorCardCategorySelection.Category();
      champions.name = "Champions";
      champions.cards = new DirectorCard[] { new DirectorCard() { spawnCard = AugmentedStages.clayDunestrider, selectionWeight = 2 }, new DirectorCard() { spawnCard = AugmentedStages.xiConstruct, selectionWeight = 2 } };
      champions.selectionWeight = 2;
      DirectorCardCategorySelection.Category special = new DirectorCardCategorySelection.Category();
      special.name = "Special";
      special.cards = new DirectorCard[] { new DirectorCard() { spawnCard = AugmentedStages.scav, selectionWeight = 1 } };
